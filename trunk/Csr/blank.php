...
$_SESSION["cantidad"]=$c_funciones->getCantidadRequerimientosMinimosCategoria(1,1);				
...
<body>
	<div id="page">
		...
		<div class="content">
		<form action="blank2.php" method="POST" data-ajax="false">
			...
			<table data-role="table"id="movie-table-custom" data-mode="reflow" class="movie-list table-stripe">
				...
				<tbody>
					<?php 
					$result = $c_funciones->getRequerimientosMinimosCategoria(1,1);
...
while ($row = mysqli_fetch_array($result, MYSQL_NUM)){
	...
	echo '	<input type="checkbox" name="chkRequerimientos1[]" id="chk'. $row[0] . '" value="' . $row[0] . '"/></td>';
	echo '</tr>';
}					
?>					
</tbody>
